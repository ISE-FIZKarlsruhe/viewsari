...
BIOGRAPHIES = [
    ...
    ("Giuliano da Maiano", "giuliano-da-maiano", 15, 3),
    ("Piero della Francesca", "piero-della-francesca", 17, 3),
    ("Fra Giovanni da Fiesole (Fra Angelico)", "fra-angelico", 25, 3),
    ("Leon Battista Alberti", "alberti", 41, 3),
    ("Lazzaro Vasari", "lazzaro-vasari", 55, 3),
    ("Antonello da Messina", "antonello-da-messina", 59, 3),
    ("Alesso Baldovinetti", "baldovinetti", 67, 3),
    ("Vellano da Padova", "vellano", 73, 3),
    ("Fra Filippo Lippi", "fra-filippo-lippi", 77, 3),
    ("Paolo Romano and Maestro Mino and Chimenti Camicia", "paolo-romano", 99, 3),
    ("Andrea dal Castagno and Domenico Viniziano", "andrea-dal-castagno", 107, 3),
    ("Gentile da Fabriano and Vittore Pisanello", "gentile-pisanello", 121, 3),
    ("Pesello and Francesco Peselli", "pesello-peselli", 131, 3),
    ("Benozzo Gozzoli", "benozzo-gozzoli", 137, 3),
    ("Francesco di Giorgio and Lorenzo Vecchietto", "francesco-di-giorgio", 155, 3),
    ("Galasso Ferrarese", "galasso-ferrarese", 165, 3),
    ("Antonio Rossellino and Bernardo Rossellino", "rossellino", 169, 3),
    ("Desiderio da Settignano", "desiderio-da-settignano", 181, 3),
    ("Mino da Fiesole", "mino-da-fiesole", 189, 3),
    ("Lorenzo Costa", "lorenzo-costa", 199, 3),
    ("Ercole Ferrarese", "ercole-ferrarese", 205, 3),
    ("Jacopo Giovanni and Gentile Bellini", "bellini", 209, 3),
    ("Cosimo Rosselli", "cosimo-rosselli", 225, 3),
    ("Cecca", "cecca", 233, 3),
    ("Don Bartolommeo della Gatta", "don-bartolommeo-della-gatta", 239, 3),
    ("Gherardo", "gherardo", 245, 3),
    ("Benedetto da Maiano", "benedetto-da-maiano", 249, 3),
    ("Domenico Ghirlandajo", "ghirlandajo", 261, 3),
    ("Tommaso", "tommaso", 295, 3),
    ("Filippino Lippi", "filippino-lippi-vol3", 297, 3),
    ("Bernardino Pinturicchio", "pinturicchio", 319, 3),
    ("Francesco Francia", "france-francia", 335, 3),
    ("Pietro Perugino", "perugino", 347, 3),
    ("Vittore Carpaccio and Others", "vittore-carpaccio", 385, 3),
    ("Andrea Mantegna", "mantegna", 391, 3),
    # VOL 4
